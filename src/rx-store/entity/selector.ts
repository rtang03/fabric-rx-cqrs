...
export function defaultStateFn(
  state: any,
  selectors: Array<Selector<any, any>>,
...
export function createSelectorFactory(
  ...
  return (...input: any[]): Selector<any, any> => {
    let args = input;
    ...
    const memoizedProjector = memoize((..._selectors: any[]) =>
      projector.apply(null, _selectors)
    );

    const memoizedState = defaultMemoize((state: any) =>
